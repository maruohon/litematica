...
public class VerifierResultSorter implements Comparator<BlockMismatch>
{
    ...
    public int compare(BlockMismatch entry1, BlockMismatch entry2)
    {
        ...
        if (sortCriteria == SortCriteria.COUNT)
        {
            ...
            if (count1 == count2)
            {
                String name1 = ItemUtils.getItemForState(entry1.stateExpected).getDisplayName();
                String name2 = ItemUtils.getItemForState(entry2.stateExpected).getDisplayName();
        ...
        else
        {
            ...
            String name1_1 = ItemUtils.getItemForState(state1_1).getDisplayName();
            String name1_2 = ItemUtils.getItemForState(state1_2).getDisplayName();
            ...
            String name2_1 = ItemUtils.getItemForState(state2_1).getDisplayName();
            String name2_2 = ItemUtils.getItemForState(state2_2).getDisplayName();
