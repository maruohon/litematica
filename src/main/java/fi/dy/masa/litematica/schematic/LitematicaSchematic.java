...
public class LitematicaSchematic
{
    ...
    private void readSubRegionsFromNBT(NBTTagCompound tag, int version, int minecraftDataVersion)
    {
    ...
    private NBTTagList convertBlockStatePalette_1_12_to_1_13_2(NBTTagList oldPalette, int version, int minecraftDataVersion)
    {
        ...
        {
            NBTTagList newPalette = new NBTTagList();
