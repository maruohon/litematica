...
public class SchematicConverter
{
    ...
    public CompoundNBT fixTileEntityNBT(CompoundNBT tag, BlockState state)
    {
        ...
        {
            Litematica.logger.warn("Failed to update TileEntity data for block '{}'", state, e);
        }
        */
    ...
    public static void postProcessBlocks(LitematicaBlockStateContainer container, @Nullable Map<BlockPos, CompoundNBT> tiles,
    ...
    public static class BlockReaderLitematicaContainer implements IBlockReaderWithData
    {
        ...
        @Override
        @Nullable
        public CompoundNBT getTileEntityData(BlockPos pos)
        {
