...
public class OverlayRenderer
{
    ...
    public void renderHoverInfo(Minecraft mc, MatrixStack matrixStack)
    {
    ...
    private void renderBlockInfoLines(RayTraceWrapper traceWrapper, Minecraft mc, MatrixStack matrixStack)
    {
    ...
    private boolean renderVerifierOverlay(Minecraft mc, MatrixStack matrixStack)
    {
        SchematicPlacement placement = DataManager.getSchematicPlacementManager().getSelectedSchematicPlacement();
    ...
    private void renderBlockInfoOverlay(RayTraceWrapper traceWrapper, Minecraft mc, MatrixStack matrixStack)
    {
