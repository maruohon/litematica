...
public class SchematicPlacementSubRegionSettingsScreen extends BaseScreen
{
    ...
    {
        String val = fi.dy.masa.litematica.util.PositionUtils.getMirrorName(this.subRegion.getMirror());
    ...
    {
        String val = fi.dy.masa.litematica.util.PositionUtils.getRotationNameShort(this.subRegion.getRotation());
