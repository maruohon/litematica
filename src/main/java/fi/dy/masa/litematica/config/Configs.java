...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigBoolean       PASTE_IGNORE_GAMEMODE   = new ConfigBoolean(   "pasteIgnoreGamemode", false, "If disabled, then the Paste feature will only work in creative mode");
