...
public class Hotkeys
{
    ...
    public static final ConfigHotkey OPEN_GUI_AREA_SETTINGS             = new ConfigHotkey("openGuiAreaSettings",               "KP_MULTIPLY",  KeybindSettings.EXCLUSIVE, "Open the Area Settings GUI for the currently selected area");
