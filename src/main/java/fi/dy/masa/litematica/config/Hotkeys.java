...
public class Hotkeys
{
    ...
    public static final HotkeyConfig INVERT_OVERLAY_RENDER_STATE            = new HotkeyConfig("invertOverlayRenderState", "");
    public static final HotkeyConfig INVERT_SCHEMATIC_RENDER_STATE          = new HotkeyConfig("invertSchematicRenderState", "");
    public static final HotkeyConfig LAYER_MODE_NEXT                        = new HotkeyConfig("layerModeNext", "M,PRIOR");
    public static final HotkeyConfig LAYER_MODE_PREVIOUS                    = new HotkeyConfig("layerModePrevious", "M,NEXT");
    public static final HotkeyConfig LAYER_NEXT                             = new HotkeyConfig("layerNext", "PRIOR");
    public static final HotkeyConfig LAYER_PREVIOUS                         = new HotkeyConfig("layerPrevious", "NEXT");
    ...
    public static final HotkeyConfig OPERATION_MODE_CHANGE_MODIFIER         = new HotkeyConfig("operationModeChangeModifier", "LCONTROL", KeyBindSettings.INGAME_MODIFIER);
    public static final HotkeyConfig PICK_BLOCK_FIRST                       = new HotkeyConfig("pickBlockFirst", "BUTTON2");
    public static final HotkeyConfig PICK_BLOCK_LAST                        = new HotkeyConfig("pickBlockLast", "", KeyBindSettings.INGAME_MODIFIER);
    ...
    public static final HotkeyConfig RENDER_OVERLAY_THROUGH_BLOCKS          = new HotkeyConfig("renderOverlayThroughBlocks", "RCONTROL", KeyBindSettings.INGAME_MODIFIER);
    ...
    public static final HotkeyConfig SELECTION_NUDGE_MODIFIER               = new HotkeyConfig("selectionNudgeModifier", "LMENU", KeyBindSettings.INGAME_MODIFIER);
    public static final HotkeyConfig SELECTION_MODE_CYCLE                   = new HotkeyConfig("selectionModeCycle", "LCONTROL,M");
    ...
    public static final HotkeyConfig TOOL_PLACE_CORNER_1                    = new HotkeyConfig("toolPlaceCorner1", "BUTTON0");
    public static final HotkeyConfig TOOL_PLACE_CORNER_2                    = new HotkeyConfig("toolPlaceCorner2", "BUTTON1");
    public static final HotkeyConfig TOOL_SELECT_ELEMENTS                   = new HotkeyConfig("toolSelectElements", "BUTTON2");
    public static final HotkeyConfig TOOL_SELECT_MODIFIER_BLOCK_1           = new HotkeyConfig("toolSelectModifierBlock1", "LMENU", KeyBindSettings.INGAME_MODIFIER);
    public static final HotkeyConfig TOOL_SELECT_MODIFIER_BLOCK_2           = new HotkeyConfig("toolSelectModifierBlock2", "LSHIFT", KeyBindSettings.INGAME_MODIFIER);
