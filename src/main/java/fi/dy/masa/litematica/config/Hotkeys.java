...
public class Hotkeys
{
    ...
    public static final HotkeyConfig EASY_PLACE_ACTIVATION              = new HotkeyConfig("easyPlaceActivation", "", KeyBindSettings.MODIFIER_INGAME_EMPTY, "When the easyPlaceMode is enabled, this key must\nbe held to enable placing the blocks when\nusing the vanilla Use key");
    ...
    public static final HotkeyConfig OPEN_GUI_MAIN_MENU                 = new HotkeyConfig("openGuiMainMenu", "M", KeyBindSettings.RELEASE_EXCLUSIVE, "Open the Litematica main menu");
    ...
    public static final HotkeyConfig OPERATION_MODE_CHANGE_MODIFIER     = new HotkeyConfig("operationModeChangeModifier", "LCONTROL", KeyBindSettings.MODIFIER_INGAME, "The modifier key to quickly change the operation mode.\nHold this and scroll while holding the \"tool item\" to quickly cycle the mode.");
    public static final HotkeyConfig PICK_BLOCK_FIRST                   = new HotkeyConfig("pickBlockFirst", "BUTTON2", KeyBindSettings.PRESS_ALLOWEXTRA, "A key to pick block the first\nschematic block ray traced to");
    public static final HotkeyConfig PICK_BLOCK_LAST                    = new HotkeyConfig("pickBlockLast", "", KeyBindSettings.MODIFIER_INGAME, "A key to pick block the last schematic block\nray traced to, before the first (possible) client world\nblock ray traced to. Basically this would get\nyou the block you could place against an existing block.");
    ...
    public static final HotkeyConfig RENDER_INFO_OVERLAY                = new HotkeyConfig("renderInfoOverlay", "I", KeyBindSettings.PRESS_ALLOWEXTRA, "The key that enables rendering the block info overlay.\nUse NONE for not requiring a key to be pressed.\nDisable the similarly named option in the Visuals\nconfigs to disable the overlay completely.");
    public static final HotkeyConfig RENDER_OVERLAY_THROUGH_BLOCKS      = new HotkeyConfig("renderOverlayThroughBlocks", "RCONTROL", KeyBindSettings.PRESS_ALLOWEXTRA, "A hotkey to allow the overlays to render through blocks.\nThis is just a quicker way to temporarily enable\nthe same thing that the 'schematicOverlayRenderThroughBlocks' option in Visuals does.");
    ...
    public static final HotkeyConfig SCHEMATIC_REBUILD_BREAK_ALL        = new HotkeyConfig("schematicRebuildBreakPlaceAll", "", KeyBindSettings.MODIFIER_INGAME, "Modifier key to activate the \"break all identical blocks\"\nfunction in the Schematic Rebuild tool mode");
    public static final HotkeyConfig SCHEMATIC_REBUILD_BREAK_DIRECTION  = new HotkeyConfig("schematicRebuildBreakPlaceDirection", "", KeyBindSettings.MODIFIER_INGAME, "Modifier key to activate the directional/continuous\nbreak or place function in the Schematic Rebuild tool mode");
    public static final HotkeyConfig SCHEMATIC_REBUILD_REPLACE_ALL      = new HotkeyConfig("schematicRebuildReplaceAll", "", KeyBindSettings.MODIFIER_INGAME, "Modifier key to activate the \"replace all identical\"\nreplace mode/function in the Schematic Rebuild tool mode");
    public static final HotkeyConfig SCHEMATIC_REBUILD_REPLACE_DIRECTION= new HotkeyConfig("schematicRebuildReplaceDirection", "", KeyBindSettings.MODIFIER_INGAME, "Modifier key to activate the directional/continuous\nreplace mode/function in the Schematic Rebuild tool mode");
    public static final HotkeyConfig SCHEMATIC_VERSION_CYCLE_MODIFIER   = new HotkeyConfig("schematicVersionCycleModifier", "", KeyBindSettings.MODIFIER_INGAME, "The modifier key to hold to be able to use the mouse wheel\nto cycle through the schematic versions in the Version Control tool mode");
    ...
    public static final HotkeyConfig SELECTION_EXPAND_MODIFIER          = new HotkeyConfig("selectionExpandModifier", "", KeyBindSettings.MODIFIER_INGAME, "The modifier key to hold to expand or shrink a selection box\nfrom the looking direction side while scrolling");
    public static final HotkeyConfig SELECTION_GRAB_MODIFIER            = new HotkeyConfig("selectionGrabModifier", "", KeyBindSettings.MODIFIER_INGAME, "The modifier key to hold to \"grab\" a selection\nbox or corner for cursor moving.");
    ...
    public static final HotkeyConfig SELECTION_GROW_MODIFIER            = new HotkeyConfig("selectionGrowModifier", "", KeyBindSettings.MODIFIER_INGAME, "The modifier key to hold to grow or shrink\na selection box while scrolling");
    public static final HotkeyConfig SELECTION_NUDGE_MODIFIER           = new HotkeyConfig("selectionNudgeModifier", "LMENU", KeyBindSettings.MODIFIER_INGAME, "The modifier key to hold while scrolling\nto nudge the selected area or corner");
    ...
    public static final HotkeyConfig TOOL_PLACE_CORNER_1                = new HotkeyConfig("toolPlaceCorner1", "BUTTON0", KeyBindSettings.PRESS_ALLOWEXTRA, "The button to use while holding the \"tool\" item\nto place the primary/first corner");
    public static final HotkeyConfig TOOL_PLACE_CORNER_2                = new HotkeyConfig("toolPlaceCorner2", "BUTTON1", KeyBindSettings.PRESS_ALLOWEXTRA, "The button to use while holding the \"tool\" item\nto place the second corner");
    public static final HotkeyConfig TOOL_SELECT_ELEMENTS               = new HotkeyConfig("toolSelectElements", "BUTTON2", KeyBindSettings.PRESS_ALLOWEXTRA, "The button to use to select corners or boxes\nwhile holding the \"tool\" item");
    public static final HotkeyConfig TOOL_SELECT_MODIFIER_BLOCK_1       = new HotkeyConfig("toolSelectModifierBlock1", "LMENU", KeyBindSettings.MODIFIER_INGAME, "The modifier key to hold while using the 'toolSelectElements'\nhotkey, to select the primary block type to use in some of the tool modes");
    public static final HotkeyConfig TOOL_SELECT_MODIFIER_BLOCK_2       = new HotkeyConfig("toolSelectModifierBlock2", "LSHIFT", KeyBindSettings.MODIFIER_INGAME, "The modifier key to hold while using the 'toolSelectElements'\nhotkey, to select the secondary block type to use in some of the tool modes");
