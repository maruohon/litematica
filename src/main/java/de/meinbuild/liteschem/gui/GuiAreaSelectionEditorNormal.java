...
import de.meinbuild.liteschem.gui.widgets.WidgetListSelectionSubRegions;
import de.meinbuild.liteschem.gui.widgets.WidgetSelectionSubRegion;
                                          ...
                                          implements ISelectionListener<String>
{
    ...
    protected void createCoordinateInput(int x, int y, int width, CoordinateType coordType, PositionUtils.Corner corner)
    {
        ...
        y += 2;
        BlockPos pos = corner == PositionUtils.Corner.NONE ? this.selection.getEffectiveOrigin() : this.getBox().getPosition(corner);
        String text = "";
    ...
    protected void createCoordinateButton(int x, int y, PositionUtils.Corner corner, CoordinateType coordType, ButtonListener.Type type)
    {
    ...
    protected void updateCheckBoxes()
    {
        ...
        {
            boolean checked = this.selection.getSelectedSubRegionBox() != null && this.selection.getSelectedSubRegionBox().getSelectedCorner() == PositionUtils.Corner.CORNER_1;
            this.checkBoxCorner1.setChecked(checked, false);
        }

        if (this.checkBoxCorner2 != null)
        {
            boolean checked = this.selection.getSelectedSubRegionBox() != null && this.selection.getSelectedSubRegionBox().getSelectedCorner() == PositionUtils.Corner.CORNER_2;
    ...
    protected void updatePosition(String numberString, PositionUtils.Corner corner, CoordinateType type)
    {
        try
        {
    ...
    protected void moveCoordinate(int amount, PositionUtils.Corner corner, CoordinateType type)
    {
        int oldValue = 0;
    ...
    protected static class ButtonListener implements IButtonActionListener
    {
        ...
        @Nullable private final PositionUtils.Corner corner;
        @Nullable private final CoordinateType coordinateType;

        public ButtonListener(Type type, @Nullable PositionUtils.Corner corner, @Nullable CoordinateType coordinateType, GuiAreaSelectionEditorNormal parent)
        {
            this.type = type;
            this.corner = corner;
    ...
    protected static class TextFieldListener implements ITextFieldListener<GuiTextFieldGeneric>
    {
        ...
        public TextFieldListener(CoordinateType type, PositionUtils.Corner corner, GuiAreaSelectionEditorNormal parent)
        {
            this.type = type;
            this.corner = corner;
            this.parent = parent;
