...
public class WidgetSchematicVerificationResult extends WidgetListEntrySortable<BlockMismatchEntry>
{
            ...
            BlockMismatchEntry entry, int listIndex)
    {
        ...
        else
        {
            ...
            if (entry.mismatchType != SchematicVerifier.MismatchType.CORRECT_STATE)
            {
    ...
    public void render(int mouseX, int mouseY, boolean selected, MatrixStack matrixStack)
    {
        ...
        else if (this.header1 != null)
        {
            this.drawString(this.x + 4, this.y + 7, color, this.header1, matrixStack);
                ...
                (this.mismatchEntry.mismatchType != SchematicVerifier.MismatchType.CORRECT_STATE ||
    ...
    public static class BlockMismatchInfo
    {
        ...
        public BlockMismatchInfo(BlockState stateExpected, BlockState stateFound)
        {
            ...
            w1 = Math.max(w1, de.meinbuild.liteschem.render.RenderUtils.getMaxStringRenderLength(propsExpected));
            w2 = Math.max(w2, de.meinbuild.liteschem.render.RenderUtils.getMaxStringRenderLength(propsFound));
