...
import de.meinbuild.liteschem.gui.widgets.WidgetListSchematicVerificationResults;
import de.meinbuild.liteschem.gui.widgets.WidgetSchematicVerificationResult;
import de.meinbuild.liteschem.render.infohud.InfoHud;
import de.meinbuild.liteschem.render.infohud.RenderPhase;
    ...
    private int createButton(int x, int y, int width, ButtonListener.Type type)
    {
        ...
        switch (type)
        {
            case SET_RESULT_MODE_ALL:
                label = SchematicVerifier.MismatchType.ALL.getDisplayname();
