package de.meinbuild.liteschem.selection;
...
public class AreaSelection
{
    ...
    public void moveEntireSelectionTo(BlockPos newOrigin, boolean printMessage)
    {
        ...
        for (Box box : this.subRegionBoxes.values())
        {
            if (box.getPos1() != null)
            {
                this.setSubRegionCornerPos(box, PositionUtils.Corner.CORNER_1, box.getPos1().add(diff));
            }

            if (box.getPos2() != null)
            {
                this.setSubRegionCornerPos(box, PositionUtils.Corner.CORNER_2, box.getPos2().add(diff));
            }
        }
    ...
    public void moveSelectedElement(Direction direction, int amount)
    {
        ...
        else if (box != null)
        {
            ...
            {
                BlockPos pos = this.getSubRegionCornerPos(box, PositionUtils.Corner.CORNER_1).offset(direction, amount);
            ...
            {
                BlockPos pos = this.getSubRegionCornerPos(box, PositionUtils.Corner.CORNER_2).offset(direction, amount);
    ...
    public void setCoordinate(@Nullable Box box, PositionUtils.Corner corner, CoordinateType type, int value)
    {
