...
public class Box
{
    ...
    */
    ...
    public int getCoordinate(PositionUtils.Corner corner, CoordinateType type)
    {
    ...
    public void setCoordinate(int value, PositionUtils.Corner corner, CoordinateType type)
    {
        BlockPos pos = this.getPosition(corner);
