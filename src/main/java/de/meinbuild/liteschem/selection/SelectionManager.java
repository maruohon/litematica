...
import de.meinbuild.liteschem.gui.GuiAreaSelectionEditorSimple;
...
public class SelectionManager
{
    ...
    public boolean changeSelection(World world, Entity entity, int maxDistance)
    {
        ...
        if (area != null)
        {
            ...
            else if (trace.getHitType() == RayTraceUtils.RayTraceWrapper.HitType.MISS)
            {
    ...
    public void setPositionOfCurrentSelectionToRayTrace(MinecraftClient mc, PositionUtils.Corner corner, boolean moveEntireSelection, double maxDistance)
    {
        AreaSelection area = this.getCurrentSelection();
    ...
    private static class GrabbedElement
    {
        ...
        private GrabbedElement(AreaSelection area, Box box, PositionUtils.Corner corner, Vec3d grabPosition, double grabDistance)
        {
            this.area = area;
            this.grabbedBox = box;
