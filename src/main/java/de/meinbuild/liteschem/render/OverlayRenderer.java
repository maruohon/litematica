...
import de.meinbuild.liteschem.gui.widgets.WidgetSchematicVerificationResult.BlockMismatchInfo;
...
import de.meinbuild.liteschem.util.RayTraceUtils.RayTraceWrapper;
...
public class OverlayRenderer
{
    ...
    public void renderSchematicVerifierMismatches(MatrixStack matrices, float partialTicks)
    {
        ...
        if (placement != null && placement.hasVerifier())
        {
            ...
            List<SchematicVerifier.MismatchRenderPos> list = verifier.getSelectedMismatchPositionsForRender();
    ...
    private void renderSchematicMismatches(List<SchematicVerifier.MismatchRenderPos> posList, @Nullable BlockPos lookPos, MatrixStack matrices, float partialTicks)
    {
    ...
    private boolean renderVerifierOverlay(MinecraftClient mc, MatrixStack matrixStack)
    {
        ...
        if (placement != null && placement.hasVerifier())
        {
            ...
            {
                SchematicVerifier.BlockMismatch mismatch = verifier.getMismatchForPosition(((BlockHitResult) trace).getBlockPos());
